...
QMAKE_PROJECT_PATH = $(QT5_CONTRIB_DIR)/qtbase/examples/network/dnslookup
QMAKE_PROJECT_FILE = $(QMAKE_PROJECT_PATH)/dnslookup.pro

vpath % $(QMAKE_PROJECT_PATH)

include $(QT5_REP_DIR)/src/app/qt5/tmpl/target_defaults.inc

LIBS += libc libc_resolv libc-resolv lwip libc_lwip libc_lwip_loopback libc_lwip_nic_dhcp config_args pthread
