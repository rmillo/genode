...
QMAKE_PROJECT_PATH = $(QT5_CONTRIB_DIR)/qtwebsockets/examples/websockets/simplechat
QMAKE_PROJECT_FILE = $(QMAKE_PROJECT_PATH)/simplechat.pro
...
LIBS   += qt5_network qt5_websockets lwip libc libc_lwip_loopback libc_resolv \
          libc_lwip_nic_dhcp libc_lwip_wrapper
