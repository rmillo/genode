...
QMAKE_PROJECT_PATH = $(QT5_CONTRIB_DIR)/qtbase/examples/widgets/widgets/tetrix
QMAKE_PROJECT_FILE = $(QMAKE_PROJECT_PATH)/tetrix.pro
...
LIBS += qt5_gui qt5_qpa_nitpicker qt5_widgets qt5_ui_tools
