...
QMAKE_PROJECT_PATH = $(QT5_CONTRIB_DIR)/qtbase/examples/widgets/widgets/calculator
QMAKE_PROJECT_FILE = $(QMAKE_PROJECT_PATH)/calculator.pro
...
LIBS += qt5_core qt5_gui qt5_qpa_nitpicker qt5_widgets
