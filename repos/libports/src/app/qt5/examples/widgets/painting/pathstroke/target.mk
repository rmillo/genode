...
QMAKE_PROJECT_PATH = $(QT5_CONTRIB_DIR)/qtbase/examples/widgets/painting/pathstroke
QMAKE_PROJECT_FILE = $(QMAKE_PROJECT_PATH)/pathstroke.pro

INC_DIR += $(QMAKE_PROJECT_PATH)/../shared

vpath % $(QMAKE_PROJECT_PATH)
vpath % $(QMAKE_PROJECT_PATH)/../shared
